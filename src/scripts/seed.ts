...
async function seed() {
  try {
    ...
    console.log('----------------------------------------------');
    console.log('Admin:      admin@oms.com / admin123');
    console.log('Manager:    manager@oms.com / password123');
    console.log('Sales:      sales@oms.com / password123');
    console.log('Warehouse:  warehouse@oms.com / password123');
    console.log('Delivery:   delivery@oms.com / password123');
