...
const LOOKUP_SEEDS: LookupSeed[] = [
  ...
  { category: 'order_status', code: 'processing', name: 'Processing', sortOrder: 3 },
  { category: 'order_status', code: 'picked', name: 'Picked', sortOrder: 4 },
  { category: 'order_status', code: 'packed', name: 'Packed', sortOrder: 5 },
  { category: 'order_status', code: 'ready_to_ship', name: 'Ready To Ship', sortOrder: 6 },
  { category: 'order_status', code: 'shipped', name: 'Shipped', sortOrder: 7 },
  { category: 'order_status', code: 'out_for_delivery', name: 'Out For Delivery', sortOrder: 8 },
  { category: 'order_status', code: 'delivered', name: 'Delivered', sortOrder: 9 },
  { category: 'order_status', code: 'cancelled', name: 'Cancelled', sortOrder: 10 },
  { category: 'order_status', code: 'returned', name: 'Returned', sortOrder: 11 },
  { category: 'order_status', code: 'partially_returned', name: 'Partially Returned', sortOrder: 12 },
